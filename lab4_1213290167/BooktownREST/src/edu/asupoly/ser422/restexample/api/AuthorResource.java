...
import edu.asupoly.ser422.restexample.api.JMSHelperActiveMQ;
...
public class AuthorResource {
	...
	public List<Author> getAuthors() {
	    ...
	    producer.setDeliveryMode(DeliveryMode.PERSISTENT);
			...
			uriinfo= _uriInfo.getRequestUri().toString();
			verb= "GET";
			response= "200";
	    TextMessage msg = session.createTextMessage(new Timestamp(date.getTime())+" "+ uriinfo+" "+ verb +" "+ response);
	    producer.send(msg);
    ...
    public Response createAuthor(String name) {
		...
		if (aid == -1) {
			...
			try {
			 ...
			 // msg = session.createTextMessage(new Timestamp(date.getTime())+" "+ uriinfo+" "+ verb +" 500");
